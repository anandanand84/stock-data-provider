...
class GoogleFinanceDataProvider {
    ...
    getChartData(request) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            var result = yield fetch(`https://data.traderslab.in/getprices?q=${request.scrip}&i=${request.interval}&p=${requiredNoOfdays}d&f=d,o,h,l,c,v&ts=${request.startTime}`);
    ...
    getAvailableScrips(key) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            var response = yield fetch('https://data.traderslab.in/match?matchtype=matchall&q=' + key);
    ...
    getQuote(scrip, exchange) {
        return __awaiter(this, void 0, void 0, function* () {
            var response = yield fetch(`https://data.traderslab.in/info?q=${exchange}:${scrip}`);
